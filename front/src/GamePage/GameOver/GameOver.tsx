...
function GameOver(props: any) {
    ...
    return (
        <div className="gameover">
            <h2>{displayWinner()} <br />won</h2>
            <button onClick={() => {props.setDifficulty(0)}}>
                <svg fill="#FFFF" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 305.84 305.84" xmlSpace="preserve" transform="rotate(0)matrix(1, 0, 0, 1, 0, 0)" stroke="#000000" stroke-width="0.0030583600000000004">
